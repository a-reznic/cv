...
|------------------------------|------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 06.2023 - current [**1y+**]  | Senior Android Developer(**FullScreenDigital**)      | Contract, support app, create new apps using Jetpack Compose                                                                                                                                                                                                                                              |
| 01.2023 - 06.2023 [**6m**]   | Senior Android Developer(**Happydemy**)              | Social Media application(like Instagram), Compose, Clean Architecture. [google play](https://play.google.com/store/apps/details?id=connect.happydemy.goomood)                                                                                                                                                                                                                    |
...
* Clean Architecture, MVVM, MVP, MVI, Jetpack Compose
* Room, Realm
...
Highly motivated and enthusiastic Senior Mobile Development Engineer with more than 18 years of software engineering
...
[compilebenchmark.com](https://compilebenchmark.com/)
